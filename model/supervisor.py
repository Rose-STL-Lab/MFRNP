...
class Supervisor:
    def __init__(self, save_dir, ray_config=None, **kwargs):
        ...
        self.clip_grad =  kwargs["train"].get('clip_grad', False)
        ...
        self.lower_fidelity_weight = kwargs["train"].get("lower_fidelity_weight", 0.2)
        ...
        # model
        self.model = Model.MultiFidelityModel(
    ...
    def _run_epoch(self, loader, train=False):
        ...
        if train:
            self.z_mu = output["z_mu_all"]
            self.z_cov = output["z_cov_all"]
        ...
        for level in range(1, self.levels+1):
            ...
            if train:
                ...
                if level == self.levels:
                    ...
                    loss_value = nll_loss * self.lower_fidelity_weight + kld_loss
            else:
                if level == self.levels:
